...
var botConfigs = {
    token: "ODY3ODE2ODI3NDM3NDQ5MjU3.YPmnZg.K_nxpIvQW1utnQLXewjgOlZqOFs",
    prefix: "!",
    gameStatus: "REDSIDE",
    statusType: "PLAYING",
    commands: [
        ...
        "embedFields": [
            {
                ...
                "text": "Suis bien l'exemple pour les captures, n'oublie pas le téléphone d'ouvert. Et ceci --> run 1---24/05---22h44---350 coca. Tenue Obligatoire en travaillant, si vous ne portez pas la tenue vous aurez 1 averto. Tu peux aller voir dans #exemple pour plus de facilité."
            }
        ]
    }
],
